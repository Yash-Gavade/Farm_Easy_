  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        return const _AppWithProviders(); // Safe initialization now
      },
    );
  }
}

class _AppWithProviders extends StatefulWidget {
  const _AppWithProviders({super.key});

  @override
  State<_AppWithProviders> createState() => _AppState();
}

class _AppState extends State<_AppWithProviders> {
  // Collection Reference
  late CollectionReference _accountCollection;
  ...
  @override
  void initState() {
    _accountCollection = FirebaseFirestore.instance.collection(CollectionsName.kACCOUNT);
    _productCollection = FirebaseFirestore.instance.collection(CollectionsName.kPRODUCT);
    _transactionCollection = FirebaseFirestore.instance.collection(CollectionsName.kTRANSACTION);
