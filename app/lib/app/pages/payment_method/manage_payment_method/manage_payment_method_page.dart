...
class ManagePaymentMethodPage extends StatefulWidget {
  ...
  @override
  State<ManagePaymentMethodPage> createState() =>
      _ManagePaymentMethodPageState();
}
    ...
    SchedulerBinding.instance.addPostFrameCallback(
      (_) {
        ...
        selectedPaymentMethod =
            context.read<AccountProvider>().account.primaryPaymentMethod;
        context
            .read<PaymentMethodProvider>()
            .getPaymentMethod(accountId: accountId);
      },
    );
    super.initState();
  }
                        ...
                        ...value.listPaymentMethod.map(
                          (e) => Padding(
                            ...
                            child: RadioCard<PaymentMethod>(
                              ...
                              onEdit: () {
                                NavigateRoute.toEditPaymentMethod(
                                    context: context, paymentMethod: e);
                              },
                            ),
                          ),
                        )
